...
//    method4();
  ...
  private static void method1() {
    Person p1 = new PersonBuilder().name("Matt").empNo(1).gender(Gender.MALE).build();
    Person p2 = new PersonBuilder().name("David").empNo(2).gender(Gender.MALE).build();
    Person p3 = new PersonBuilder().name("Rhys").empNo(3).gender(Gender.MALE).build();
    Person p4 = new PersonBuilder().name("Thomas").empNo(4).gender(Gender.MALE).build();
    Person p5 = new PersonBuilder().name("Meta").empNo(5).gender(Gender.FEMALE).build();
    Person p6 = new PersonBuilder().name("Sophie").empNo(6).gender(Gender.FEMALE).build();
    Person p7 = new PersonBuilder().name("Sunny").empNo(7).gender(Gender.FEMALE).build();
    Person p8 = new PersonBuilder().name("Cathy").empNo(8).gender(Gender.FEMALE).build();

    Map<Gender, List<Person>> empls = getEmpls()
        .stream().collect(Collectors.groupingBy(Person::getGender, Collectors.toList()));
  ...
  private static void method4() {
    ...
    tiredEmpls.forEach(emp -> {
      ...
      System.out.printf("%s\t(%03d)\t(%s)\t\n", emp.getName(), emp.getEmpNo(), emp.getWorkHour().toPlainString());
